// src/components/SubjectDetails/First.jsx
import React from 'react'

function First({ title, image }) {
  return (
    <section
    ...
    >
      ...
      <div className="container">
        <div className="row align-items-center extra-small-screen">
          <div
            className="col-xl-6 col-lg-7 col-md-8 col-sm-9 position-relative page-title-extra-small appear anime-child anime-complete"
          ...
          >
            <h1 className="mb-20px alt-font text-yellow">Courses details</h1>
